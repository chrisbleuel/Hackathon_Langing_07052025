...
export const Hero = () => {
  return (
    <section className="w-full relative overflow-hidden">
      ...
      <div className="absolute top-1/2 right-0 transform -translate-y-1/2 w-[31%] bg-white bg-opacity-90 p-8">
        <div className="max-w-[564px]">
          ...
          <Button 
            className="mt-8 text-white bg-[#0072EF] px-8 py-3 rounded-[3px] font-medium tracking-[1px] hover:bg-[#0058B8] transition-colors"
          >
            Shop now
          </Button>
        </div>
