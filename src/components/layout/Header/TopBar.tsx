...
export const TopBar = () => {
  return <div className="justify-center items-center flex min-h-[28px] w-full gap-20 overflow-hidden text-xs text-white tracking-[0.08px] bg-[#32373E] pt-0 pb-0 px-4">
